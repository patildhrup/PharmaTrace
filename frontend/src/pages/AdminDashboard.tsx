...
const AdminDashboard: React.FC = () => {
	...
	const flowRoles = [
		{ id: 'supplier', name: 'Supplier', icon: '🏭', color: 'from-blue-500 to-blue-600' },
		{ id: 'manufacturer', name: 'Manufacturer', icon: '⚗️', color: 'from-purple-500 to-purple-600' },
		{ id: 'distributor', name: 'Distributor', icon: '📦', color: 'from-orange-500 to-orange-600' },
		{ id: 'transport', name: 'Transport', icon: '🚚', color: 'from-yellow-500 to-yellow-600' },
		{ id: 'retailer', name: 'Retailer', icon: '🏥', color: 'from-green-500 to-green-600' }
	];
	...
	return (
		<div className="min-h-screen relative overflow-hidden transition-colors duration-300" style={{
			...
			<div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
				...
				<div className="bg-[#111] border border-[rgba(34,197,94,0.2)] rounded-xl p-8">
